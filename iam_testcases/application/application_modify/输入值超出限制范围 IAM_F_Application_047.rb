...
#
testcase {
    attr = {"id" => "IAM_F_Application_047", "level" => "P3", "auto" => "n"}

    def prepare
        @rs = ""
        @tc_app_comments_beyond = "中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zi"+
              "mu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^&*中文24zimu$%^"+
              "&*中文224zim24zim24zim24zim24zimm24zimm24zimm24zimm24zimm12345678"
        p "comments简介输入框中输入#{@tc_app_comments_beyond.size}个字符！".encode("GBK")
    ...
    def process
        ...
        operate("4、修改comments超出最大范围；") {
            args = {"name"=>"#{@ts_app_name_001}","provider"=>"#{@ts_app_provider_001}","redirect_uri"=>"#{@ts_app_redirect_uri}","comments"=>"#{@tc_app_comments_beyond}"}
            ...
            assert_equal(@tc_app_comments_beyond, rs_detail["comments"], "修改comments简介后查询未修改成功！")
        }
