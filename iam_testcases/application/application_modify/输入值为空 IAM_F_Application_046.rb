...
testcase {
    ...
    def process
        ...
        operate("4、修改comments为为空；") {
            args = {"name"=>"#{@ts_app_name_001}","provider"=>"#{@ts_app_provider_001}","redirect_uri"=>"#{@ts_app_redirect_uri}","comments"=>"#{@tc_app_comments_nil}"}
            ...
            assert_equal(@tc_app_comments_nil, rs_detail["comments"], "修改comments简介后查询未修改成功！")
        }
