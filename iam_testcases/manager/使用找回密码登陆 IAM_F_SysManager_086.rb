...
testcase {
  ...
  def process
    ...
    operate("2、使用新密码登录；") {
      ...
      assert_equal(@ts_err_pwformat_code, rs_login["err_code"], "密码为空应提示失败!")
      assert_equal(@ts_err_pwformat, rs_login["err_msg"], "密码为空应提示失败!")
      assert_equal(@ts_err_pwformat_desc, rs_login["err_desc"], "密码为空应提示失败!")
    }
