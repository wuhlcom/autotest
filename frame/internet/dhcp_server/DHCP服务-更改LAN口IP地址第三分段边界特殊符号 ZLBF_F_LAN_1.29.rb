...
testcase {
		...
		def prepare
				...
				@tc_lan_ip1      = "192.168. .1"
				@tc_lan_ip2      = "192.168. 100.1"
				@tc_lan_ip3      = "192.168.100 .1"
				@tc_lan_ip4      = "192.168.10 0.1"
				@tc_lan_ip5      = "192.168.@.1"
				@tc_lan_ip6      = "192.168.d00.1"
				@tc_lan_ip7      = "192.168.10.0.1"
				@tc_flag         = false
		end
		...
		def process
				...
				operate("2、分别更改DHCP服务地址为，如192.100.@.1，192.100.x.1,192.100.空格.1,192.100.16空格8.1,192.100.168空格.1，192.100.16-8.1等特殊符号") {
