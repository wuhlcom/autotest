...
# --WPA-TKIP加密模式拆分成4个脚本
# author:liluping
# date:2015-10-20 17:05:05
# modify:
#
testcase {
    attr = {"id" => "ZLBM_1.1.9", "level" => "P1", "auto" => "n"}

    def prepare
        @tc_dumpcap_pc2               = DRbObject.new_with_uri(@ts_drb_pc2)
        @tc_ap_url                    = "192.168.50.1"
        @tc_ap_wireless_pattern_value = "802.11b"
    ...
    def process
        ...
        operate("1、陪测AP使用Atheros方案并接入Internet，无线模式为b，信道指定为CH11，频宽设置为40M频宽，加密为WPA-TKIP；") {
