...
testcase {
		...
		def prepare
				...
				@tc_bandwidth_limit1     = 7000
				@tc_bandwidth_limit2     = 3000
				#bps
				@tc_bandwidth_total_bps   = 10240000
				@tc_bandwidth_limit_bps1  = 7168000
				@tc_bandwidth_limit_bps2  = 3072000
		...
		def process
				...
				operate("2、假设当前LAN口地址为192.168.100.1，设置规则1地址段为192.168,100.2到192.168,100.2，规则为保障最小带宽，带宽为700kbps；设置规则2地址段为192.168,100.3到192.168,100.3，规则为保障最小带宽，带宽为300kbps，启用规则1和规则2") {
						...
						#规则2
						@options_page.add_item
						@options_page.set_client_bw(2, @tc_wifi_ip.split(".").last, @tc_wifi_ip.split(".").last, @ts_tag_bandensure, @tc_bandwidth_limit2)
				...
				operate("4、客户端2下载") {
						...
						flag1 = banwith_wireless1 >= @tc_bandwidth_limit_bps2 && banwith_wireless1 <= @tc_bandwidth_total_bps
						...
						flag2 = banwith_wireless2 >= @tc_bandwidth_limit_bps2 && banwith_wireless2 <= @tc_bandwidth_total_bps
						...
						flag3 = banwith_wireless3 >= @tc_bandwidth_limit_bps2 && banwith_wireless3 <= @tc_bandwidth_total_bps
