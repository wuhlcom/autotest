...
testcase {
		...
		def prepare
				...
				@tc_cap_gap        = 5
				#bps
				@ts_bw_max_bps     = @ts_bw_max.to_i*1024
		...
		def process
				...
				operate("2、输入申请带宽值为最大值#{@ts_bw_max}，点击保存") {
						@options_page.set_total_bw(@ts_bw_max) #设置总带宽
				...
				operate("3、客户端进行下载测试") {
						...
						loss_speed1 = ((banwith_max_rate1-@ts_bw_max_bps).to_f.abs/@ts_bw_max_bps)
						puts loss_speed1
						...
						loss_speed2 = ((banwith_max_rate2-@ts_bw_max_bps).to_f.abs/@ts_bw_max_bps)
						puts loss_speed2
						...
						loss_speed3 = ((banwith_max_rate3-@ts_bw_max_bps).to_f.abs/@ts_bw_max_bps)
						puts loss_speed3
						flag3 = loss_speed3<=0.1

						rs_rate_flag = (flag1&&flag2||flag3)||(flag1||flag2&&flag3)||(flag1&&flag3||flag2)
						assert(rs_rate_flag, "总带宽限制为#{@ts_bw_max}不生效")
				}
