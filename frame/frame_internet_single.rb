...
module Frame
		class WebTestInternet<WebTestNameSpace
				...
				@@report_path_internet = current_path+"/reports/#{$report_date}/internet"
				#stdio("#{@@report_path_internet}/internet.log")
				...
				tc_el  = tcs_el.elements.each("TestCase") { |tc|
						...
						next if tc_name !~ /命令恢复出厂设置 ZLBF_21.1.30/i
						...
						if File.exist?(tc_file) && tc.attributes["auto"]=~/y/i
								File.open(tc_file, "r") { |tc|
										...
										define_method "test_#{tc_name}" do
												report_fpath = @@report_path_internet+"/#{tc_name}.log"
												...
												begin
														...
														puts "======================================================="
														report_image1 = @@report_path_internet+"/images/#{tc_name}_progress.png"
														...
														begin
																...
																puts "======================================================="
																report_image2 = @@report_path_internet+"/images/#{tc_name}_clearup.png"
