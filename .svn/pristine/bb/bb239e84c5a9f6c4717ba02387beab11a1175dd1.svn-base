...
testcase {
		...
		def prepare
				...
				@tc_lan_ip1      = "192. .100.1"
				@tc_lan_ip2      = "192. 168.100.1"
				@tc_lan_ip3      = "192.168 .100.1"
				@tc_lan_ip4      = "192.1 68.100.1"
				@tc_lan_ip5      = "192.@.100.1"
				@tc_lan_ip6      = "192.f68.100.1"
				@tc_lan_ip7      = "192.16-8.100.1"
				@tc_flag         = false
		end
		...
		def process
				...
				operate("2、分别更改DHCP服务地址为，如100.@.100.1，100.x.100.1,192.空格.100.1,192.16空格8.100.1,192.168空格.100.1，192.16-8.100.1等特殊符号") {
