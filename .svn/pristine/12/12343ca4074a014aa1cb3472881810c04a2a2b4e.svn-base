...
#
testcase {
		attr = {"id" => "ZLBF_11.1.31", "level" => "P3", "auto" => "n"}
		...
		def process
				...
				operate("1、输入框中输入#{@ts_linknum_less}，点击保存") {
						...
						@wifi_page.modify_ssid1_linknum_5g(@ts_linknum_less)
						@wifi_page.save_wifi
						...
						@wifi_page.modify_ssid2_linknum_5g(@ts_linknum_less)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						@wifi_page.modify_ssid3_linknum_5g(@ts_linknum_less)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						@wifi_page.modify_ssid4_linknum_5g(@ts_linknum_less)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid5_5g?
								...
								@wifi_page.modify_ssid5_linknum_5g(@ts_linknum_less)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid6_5g?
								...
								@wifi_page.modify_ssid6_linknum_5g(@ts_linknum_less)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid7_5g?
								...
								@wifi_page.modify_ssid7_linknum_5g(@ts_linknum_less)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid8_5g?
								...
								@wifi_page.modify_ssid8_linknum_5g(@ts_linknum_less)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
				...
				operate("2、输入框中输入#{@ts_linknum_more}，点击保存；") {
						...
						@wifi_page.modify_ssid1_linknum_5g(@ts_linknum_more)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						@wifi_page.modify_ssid1_linknum_5g(@ts_linknum_max)
						@wifi_page.modify_ssid2_linknum_5g(@ts_linknum_more)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						@wifi_page.modify_ssid2_linknum_5g(@ts_linknum_max)
						@wifi_page.modify_ssid3_linknum_5g(@ts_linknum_more)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						@wifi_page.modify_ssid3_linknum_5g(@ts_linknum_max)
						@wifi_page.modify_ssid4_linknum_5g(@ts_linknum_more)
						@wifi_page.save_wifi
						error_tip = @wifi_page.wifi_error
						puts "ERROR TIP:#{error_tip}".to_gbk
						unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid5_5g?
								...
								@wifi_page.modify_ssid4_linknum_5g(@ts_linknum_max)
								@wifi_page.modify_ssid5_linknum_5g(@ts_linknum_more)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid6_5g?
								...
								@wifi_page.modify_ssid5_linknum_5g(@ts_linknum_max)
								@wifi_page.modify_ssid6_linknum_5g(@ts_linknum_more)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid7_5g?
								...
								@wifi_page.modify_ssid6_linknum_5g(@ts_linknum_max)
								@wifi_page.modify_ssid7_linknum_5g(@ts_linknum_more)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
						...
						if @wifi_page.ssid8_5g?
								...
								@wifi_page.modify_ssid7_linknum_5g(@ts_linknum_max)
								@wifi_page.modify_ssid8_linknum_5g(@ts_linknum_more)
								@wifi_page.save_wifi
								error_tip = @wifi_page.wifi_error
								puts "ERROR TIP:#{error_tip}".to_gbk
								unless error_tip == @tc_error_tip
