...
#
testcase {
  attr = {"id" => "IAM_F_SysManager_084", "level" => "P3", "auto" => "n"}
  ...
  def process
    ...
    operate("3、新密码密码带有空格；") {
      ...
      puts "原密码为#{@tc_add_pw},修改密码为'#{@tc_mod_pw2}'".to_gbk
      rs = @iam_obj.mobile_manager_modpw(@tc_man_name, @tc_mod_pw2, @tc_add_pw, @tc_nickname)
