...
#
testcase {
		attr = {"id" => "ZLBF_27.1.21", "level" => "P2", "auto" => "n"}
		...
		def prepare
				...
				#有线客户端下载
				@tc_cap_wired_client1   = "D:/ftpcaps/ftp_wired_repeater_band1.pcapng"
				@tc_cap_wired_client2   = "D:/ftpcaps/ftp_wired_repeater_band2.pcapng"
				@tc_cap_wired_client3   = "D:/ftpcaps/ftp_wired_repeater_band3.pcapng"

				@tc_cap_wired_client4 = "D:/ftpcaps/ftp_wired_repeater_band4.pcapng"
				@tc_cap_wired_client5 = "D:/ftpcaps/ftp_wired_repeater_band5.pcapng"
				@tc_cap_wired_client6 = "D:/ftpcaps/ftp_wired_repeater_band6.pcapng"

				#DRB有线客户端下载
				@tc_cap_drb_client1   = "D:/ftpcaps/ftp_drb_repeater_band1.pcapng"
				@tc_cap_drb_client2   = "D:/ftpcaps/ftp_drb_repeater_band2.pcapng"
				@tc_cap_drb_client3   = "D:/ftpcaps/ftp_drb_repeater_band3.pcapng"
				@tc_ftp_action        = "get"
				@tc_ap_pw             = "zhilutest"
		end
		...
		def process
				...
				operate("1、AP设置为中继方式上网，开启IP带宽控制，设置总带宽为1000kbps") {
						#登录上层AP,获取SSID和密码
						...
						#选择中继模式
						unless @wan_iframe.radio(id: @ts_tag_repeater_radio).checked?
								@wan_iframe.radio(id: @ts_tag_repeater_radio).click
						end
						...
						3.times do
								@browser.refresh
								sleep @tc_wait_time
								@browser.refresh unless @browser.span(:id => @ts_tag_status).exists? #如果首页面出现空白，继续刷新
						...
						assert_match(/#{@ts_tag_ip_regxp}/, wan_addr, '中断失败未获取到IP地址！')
						assert_match(/#{@ts_wan_mode_repeater}/, access_type, '接入类型错误！')
