...
#
testcase {
    attr = {"id" => "ZLBF_29.1.3", "level" => "P2", "auto" => "n"}
    ...
    def process
        ...
        operate("1、进入到防火墙界面，将防火墙总开关关闭，URL过滤关闭，保存；") {
        ...
        operate("2、进入URL过滤界面添加黑名单，添加www.baidu.com的规则，PC1和PC2能否访问www.baidu.com及其它网站；") {
            ...
            if !@option_iframe.span(text: @tc_tag_url_baidu).exists?
                ...
                assert_equal(@option_iframe.div(id: "black", class_name: @tc_intset_list).text, @tc_tag_url_baidu, "error-->黑名单添加关键字#{@tc_tag_url_baidu}不成功！")
        ...
        operate("3、再设置就白名单，添加www.sohu.com的规则，PC1和PC2能否访问www.sohu.com及其它网站。") {
            ...
            if !@option_iframe.span(text: @tc_tag_url_sohu).exists?
                ...
                assert_equal(@option_iframe.div(id: "white", class_name: @tc_intset_list).text, @tc_tag_url_sohu, "error-->白名单添加关键字#{@tc_tag_url_sohu}不成功！")
                @option_iframe.button(id: @tc_tag_save_button).click
            end
