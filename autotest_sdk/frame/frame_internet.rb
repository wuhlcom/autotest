...
module Frame
		class WebTestInternet<WebTestNameSpace
				...
				tc_el  = tcs_el.elements.each("TestCase") { |tc|
						...
						next if tc_name =~ /中继|桥|repeater|bridge|升|3g|4g|ZLBF_5.1.20|ZLBF_15.1.18|15.1.6$|13.1.23|13.1.20|13.1.30|13.1.7$|13.1.21|13.1.22|13.1.3$|13.1.4$|13.1.5$|13.1.6$|13.1.8$/i
						#next if tc_name =~ /中继|桥|3G|4G|APN|升|Repeater|Bridge/i #中继的暂不执行 2015-10-19
						# next if tc_name !~ /6.1.16/i
