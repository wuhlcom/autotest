...
if $0 == __FILE__
  $ec1 = Encoding::Converter.new("GBK", "UTF-8")
  $ec2 = Encoding::Converter.new("UTF-8", "GBK")
  class String
    def to_gbk
      $ec2.convert self rescue self
    end
...
p "大".to_utf8.encoding
  # puts '中文'.togbk
  # puts '中文'.encoding
  puts '中文'.force_encoding(Encoding::GBK).encoding
  puts '中文'.force_encoding(Encoding::UTF_8)
  puts '中文'.force_encoding(Encoding::UTF_8).encoding
