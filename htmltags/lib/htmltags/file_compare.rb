...
module HtmlTag
	...
	class FileCompare
		...
		#   若是两个文件完全相同 ， 则无任何输出
		def self.cmp2file(f1path, f2path)
			# f1           =File.open($*[0], "r")
			# f2           =File.open($*[1], "r")
...
if __FILE__==$0
	...
	p HtmlTag::FileCompare.cmp2file(filepath, filepath)
end